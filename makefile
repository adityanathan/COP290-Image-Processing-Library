output.o :
	g++ -pthread -std=c++11 multithread.cpp mkl_matrix_mult.cpp openblas_matrix_mult.cpp main.cpp cnn.cpp -o output.out -I /opt/OpenBLAS/include/ -L/opt/OpenBLAS/lib -lopenblas \
